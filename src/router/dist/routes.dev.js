...
var routes = [{
  ...
  component: function component() {
    return Promise.resolve().then(function () {
      return _interopRequireWildcard(require("layouts/landing.layout.vue"));
    });
  },
  children: [{
    path: "",
  ...
  children: [{
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("pages/student/liabilites.page.vue"));
      });
    }
  }, {
    path: "attendance",
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("pages/student/attendance.page.vue"));
      });
    }
  }, {
    path: "profile",
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("pages/student/profile.page.vue"));
      });
    }
  }]
}, {
  ...
  children: [{
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("pages/admin/liabilites.page.vue"));
      });
    }
  }, {
    path: "records",
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("pages/admin/addstudent.page.vue"));
      });
    }
  }]
